...
pub fn main() {
    let packet: Vec<u8> =
        vec![0x4d, 0x32, 0x85, 0x00, 0x00, 0x01, 0x00, 0x05, 0x00, 0x05, 0x00, 0x01, 0x01, 0x61,
    ...
    let dlh = Library::new("src/bin/c_hook/c_hook.dylib").expect("Cannot load the sample C library");
