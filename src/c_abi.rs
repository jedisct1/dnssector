...
unsafe extern "C" fn iter_edns(
    parsed_packet: *mut ParsedPacket,
    cb: unsafe extern "C" fn(ctx: *mut c_void, section_iterator: *const EdnsIterator<'_>) -> bool,
    ctx: *mut c_void,
) {
    unsafe {
...
unsafe extern "C" fn raw_name_from_str(
    ...
    unsafe {
        let raw_name_ = match r#gen::raw_name_from_str(
...
unsafe extern "C" fn set_name(
    ...
    unsafe {
        ...
        let raw_name = match r#gen::raw_name_from_str(
            slice::from_raw_parts(name as *const u8, name_len),
            default_zone_raw,
        ) {
            Err(e) => return throw_err(e, c_err),
...
pub struct FnTable {
    ...
    pub iter_edns: unsafe extern "C" fn(
        ...
        cb: unsafe extern "C" fn(
            ctx: *mut c_void,
            section_iterator: *const EdnsIterator<'_>,
        ) -> bool,
        *mut c_void,
    ),
